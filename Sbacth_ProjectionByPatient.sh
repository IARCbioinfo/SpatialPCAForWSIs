...
Rscript ProjectionElaboratedByPatient.R --sample_id TNE0001  \
                                    --spca_obj  spatial_pca_test \
                                    --path2projectors ~/LNENWork/LNEN_Molecular_groups_barlow_twin/spatial_pca/SpatialPCAObject_50k_V4.RData \
                                    ...
                                    --outdir spatial_PCA_proj_by_sample